...
pub mod exports {
    ...
    pub mod hyperlight_wasm_examples {
        ...
        ($ty:ident with_types_in $($path_to_types:tt)*) => (const _: () = {
          ...
          #[export_name = "hyperlight-wasm-examples:calculator/add#add"]
...
macro_rules! __export_adder_impl {
  ...
  $($path_to_types_root)*::exports::hyperlight_wasm_examples::calculator::add::__export_hyperlight_wasm_examples_calculator_add_cabi!($ty with_types_in $($path_to_types_root)*::exports::hyperlight_wasm_examples::calculator::add);
  )
}
#[doc(inline)]
...
B\x02\x01@\x02\x01xy\x01yy\0y\x04\0\x03add\x01\0\x04\x01'hyperlight-wasm-example\
s:calculator/add\x05\0\x04\x01)hyperlight-wasm-examples:calculator/adder\x04\0\x0b\
\x0b\x01\0\x05adder\x03\0\0\0G\x09producers\x01\x0cprocessed-by\x02\x0dwit-compo\
